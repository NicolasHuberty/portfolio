...
export const experiences: Experience[] = [
  {
    ...
    company: "UCLouvain",
    description:
      "Leading AI initiatives. Designing RAG systems, fine-tuning LLMs, and deploying production AI solutions.",
  ...
  },
  {
    ...
    company: "UCLouvain",
    description:
      "Specialized in AI, Cybersecurity, and Data Science. Thesis on clinical document de-identification.",
...
> = {
  ...
  "uclouvain-master": {
    ...
    overview:
      "Graduated with **Distinction**. I chose the unique combination of **AI and Cybersecurity** with a clear goal: to be able to build not just 'smart' systems, but **enterprise-grade, GDPR-compliant, and sovereign AI solutions**. In a world where data privacy is paramount, this dual expertise allows me to deploy AI that respects strict regulatory frameworks and security standards by design.",
    responsibilities: [
  ...
  "uclouvain-bachelor": {
    ...
    overview:
      "My Bachelor's in Computer Science provided a rigorous technical foundation, which I chose to supplement with a Minor in Entrepreneurship (Esprit d'Entreprendre). This unique combination allowed me to bridge the gap between technical implementation and business value. While the core curriculum gave me the tools to build complex systems, the entrepreneurship minor taught me to identify client needs deeply. It shifted my mindset from 'how do I code this?' to 'what problem are we actually solving?', ensuring I build useful, insightful projects linked to real-world challenges.",
    responsibilities: [
